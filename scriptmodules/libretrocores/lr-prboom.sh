...
rp_module_repo="git https://ghproxy.com/https://github.com/libretro/libretro-prboom.git master"
...
function game_data_lr-prboom() {
    ...
    if ! echo "e9bf428b73a04423ea7a0e9f4408f71df85ab175 $romdir/ports/doom/freedoom1.wad" | sha1sum -c &>/dev/null; then
        ...
        downloadAndExtract "https://ghproxy.com/https://github.com/freedoom/freedoom/releases/download/v0.12.1/freedoom-0.12.1.zip" "$dest" -j -LL
    fi
