...
rp_module_repo="git https://ghproxy.com/https://github.com/RetroPie/mupen64plus-libretro.git master"
...
function sources_lr-mupen64plus() {
    ...
    # mesa workaround; see: https://ghproxy.com/https://github.com/libretro/libretro-common/issues/98
