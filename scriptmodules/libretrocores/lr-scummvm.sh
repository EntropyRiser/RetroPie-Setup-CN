...
rp_module_repo="git https://ghproxy.com/https://github.com/libretro/scummvm.git master"
...
function configure_lr-scummvm() {
    ...
    downloadAndExtract "https://ghproxy.com/https://github.com/libretro/scummvm/raw/master/backends/platform/libretro/aux-data/scummvm.zip" "$biosdir"
