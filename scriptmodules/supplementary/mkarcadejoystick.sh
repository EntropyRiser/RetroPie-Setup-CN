...
rp_module_help="Installs the GPIO driver from https://ghproxy.com/https://github.com/cmitu/mk_arcade_joystick_rpi"
rp_module_licence="GPL2 https://raw.githubusercontent.com/recalbox/mk_arcade_joystick_rpi/master/LICENSE"
rp_module_repo="git https://ghproxy.com/https://github.com/cmitu/mk_arcade_joystick_rpi retropie"
