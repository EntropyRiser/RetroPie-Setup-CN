...
rp_module_repo="git https://ghproxy.com/https://github.com/mickelson/attract master"
...
function sources_attractmode() {
    ...
    isPlatform "rpi" && gitPullOrClone "$md_build/sfml-pi" "https://ghproxy.com/https://github.com/mickelson/sfml-pi"
}
