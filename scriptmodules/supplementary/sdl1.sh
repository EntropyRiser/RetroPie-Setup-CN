...
function sources_sdl1() {
    ...
    # add fixes from https://ghproxy.com/https://github.com/RetroPie/sdl1/compare/master...rpi
    download "https://ghproxy.com/https://github.com/RetroPie/sdl1/compare/master...rpi.diff" "debian/patches/rpi.diff"
    ...
    DEBEMAIL="Jools Wills <buzz@exotica.org.uk>" dch -v $(get_pkg_ver_sdl1) "Added rpi fixes and dispmanx support from https://ghproxy.com/https://github.com/RetroPie/sdl1/compare/master...rpi"
}
