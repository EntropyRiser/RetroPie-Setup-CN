...
rp_module_repo="git https://ghproxy.com/https://github.com/irtimmer/moonlight-embedded.git master"
...
function depends_moonlight() {
    # ref: https://ghproxy.com/https://github.com/irtimmer/moonlight-embedded/wiki/Compilation#debian-raspbian--osmc
    local depends=(
...
function build_moonlight() {
    # ref: https://ghproxy.com/https://github.com/irtimmer/moonlight-embedded/wiki/Compilation
    rm -rf build
    mkdir build
    cd build
