...
rp_module_repo="git https://ghproxy.com/https://github.com/RetroPie/retropie-splashscreens.git master"
...
function download_extra_splashscreen() {
    gitPullOrClone "$datadir/splashscreens/retropie-extra" https://ghproxy.com/https://github.com/HerbFargus/retropie-splashscreens-extra
