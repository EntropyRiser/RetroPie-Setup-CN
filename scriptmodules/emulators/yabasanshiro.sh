...
rp_module_licence="GPL2 https://ghproxy.com/https://github.com/devmiyax/yabause/blob/master/LICENSE"
rp_module_repo="git https://ghproxy.com/https://github.com/devmiyax/yabause.git pi4"
