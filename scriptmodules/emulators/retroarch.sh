...
rp_module_repo="git https://ghproxy.com/https://github.com/RetroPie/RetroArch.git retropie-v1.10.0"
...
function update_shaders_retroarch() {
    ...
    [[ ! -d "$dir/.git" ]] && rm -rf "$dir"
    gitPullOrClone "$dir" https://ghproxy.com/https://github.com/RetroPie/common-shaders.git "$branch"
...
function update_overlays_retroarch() {
    ...
    [[ ! -d "$dir/.git" ]] && rm -rf "$dir"
    gitPullOrClone "$dir" https://ghproxy.com/https://github.com/libretro/common-overlays.git
    chown -R $user:$user "$dir"
}

function update_joypad_autoconfigs_retroarch() {
    gitPullOrClone "$md_build/autoconfigs" https://ghproxy.com/https://github.com/libretro/retroarch-joypad-autoconfig.git
...
function update_assets_retroarch() {
    ...
    # remove if not a git repository for fresh checkout
    [[ ! -d "$dir/.git" ]] && rm -rf "$dir"
    gitPullOrClone "$dir" https://ghproxy.com/https://github.com/libretro/retroarch-assets.git
    chown -R $user:$user "$dir"
}
...
function _package_minimal_assets_retroarch() {
    gitPullOrClone "$md_build/assets" https://ghproxy.com/https://github.com/libretro/retroarch-assets.git
