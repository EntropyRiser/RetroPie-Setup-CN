...
rp_module_repo="git https://ghproxy.com/https://github.com/yquake2/yquake2.git QUAKE2_8_00"
...
function sources_yquake2() {
    ...
    for repo in 'xatrix' 'rogue'; do
        gitPullOrClone "$md_build/$repo" "https://ghproxy.com/https://github.com/yquake2/$repo"
    done
}
