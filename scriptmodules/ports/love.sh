...
rp_module_repo="git https://ghproxy.com/https://github.com/love2d/love master"
...
function game_data_love() {
    ...
    if [[ ! -f "$romdir/love/mari0.love" ]]; then
        downloadAndExtract "https://ghproxy.com/https://github.com/Stabyourself/mari0/archive/1.6.2.tar.gz" "$__tmpdir/mari0" --strip-components 1
