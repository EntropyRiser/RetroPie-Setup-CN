...
rp_module_repo="git https://ghproxy.com/https://github.com/Aleph-One-Marathon/alephone.git :_get_branch_alephone"
...
function game_data_alephone() {
    local release_url="https://ghproxy.com/https://github.com/Aleph-One-Marathon/alephone/releases/download/release-20150620"
