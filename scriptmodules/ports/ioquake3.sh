...
rp_module_licence="GPL2 https://ghproxy.com/https://github.com/ioquake/ioq3/blob/master/COPYING.txt"
rp_module_repo="git https://ghproxy.com/https://github.com/ioquake/ioq3 main"
